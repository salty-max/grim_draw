...
func add_card_reward() -> void:
	...
	card_reward.custom_icon = CARD_ICON
	card_reward.custom_label = CARD_LABEL
...
func _show_card_rewards() -> void:
	...
	var available_cards: Array[Card] = character_stats.draftables.cards.duplicate()
...
func _get_random_available_card(cards: Array[Card], with_rarity: Card.Rarity) -> Card:
	var all_possible_cards := cards.filter(
		func(card: Card):
